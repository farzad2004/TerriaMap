...
const MappablePreview = createReactClass({
    ...
    toggleOnMap(event) {
        document.getElementsByClassName("tjs-map-column__logo")[0].style.bottom = "-5px";// added by Farzad -logo position
        this.props.previewed.toggleEnabled();
        if (this.props.previewed.isEnabled === true && !event.shiftKey && !event.ctrlKey) {
            this.props.viewState.explorerPanelIsVisible = false;
            this.props.viewState.mobileView = null;
            console.log("ff");
             document.getElementsByClassName("tjs-map-column__logo")[0].style.bottom = "84px";//added by Farzad - logo position
        }

       
       // if (!this.props.item.isEnabled) {
       //added by Farzad - logo position
      ////  }
      ////  else {
