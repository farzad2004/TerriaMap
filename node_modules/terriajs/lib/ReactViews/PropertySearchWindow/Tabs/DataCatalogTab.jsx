...
import DataCatalog from '../../SearchResultDataCatalog/DataCatalog.jsx';
import DataCatalogMember from '../../SearchResultDataCatalog/DataCatalogMember.jsx';
import DataPreview from '../../Preview/DataPreview.jsx';
import ObserveModelMixin from '../../ObserveModelMixin';
import SearchHeader from '../../Search/SearchHeader.jsx';
import SearchBox from '../../Search/SearchBox.jsx';
import imgCardMelli from "../../../../wwwroot/images/National_Card_1.jpg";

import Styles from './data-catalog-tab.scss';
import imgpost from '../../../../wwwroot/images/logos/post.png';
import imgsabt from '../../../../wwwroot/images/logos/sabtahval.png';
                ...
                <div className={Styles.dataExplorer}>
                    <SearchBox searchText={this.props.viewState.searchState.catalogSearchText}
                      ...
                      <h3 className={Styles.h3}>
                       <img src={imgCardMelli} className={Styles.img} hidden={!this.props.viewState.searchPropertyByMelliCode && !this.props.viewState.searchPropertyByName} />
                         {this.props.viewState.searchByNameResult}
                    
                     <If condition={this.props.viewState.searchPropertyByName || this.props.viewState.searchPropertyByMelliCode}>
                         <label className={Styles.label}  ><img src={imgsabt} className={Styles.img2} />
                             {this.props.viewState.searchResultInfo}   </label>
                     </If>
                     <If condition={this.props.viewState.searchPropertyByAddress || this.props.viewState.searchPropertyByPostCode}>
                         <label className={Styles.label}  ><img src={imgpost} className={Styles.img2} />
                             {this.props.viewState.searchResultInfo}   </label>
                     </If>
