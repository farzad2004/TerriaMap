...
const MyDataTab = createReactClass({
    getInitialState: function () {
        return {
            ...
            cityValue: 'تهران',
            streetValue: 'بلوار آسمان',
            streetNumberValue: '135',
        ...
        this.props.viewState.isLoadingSearchResult = true;
            ...
            switch (e.target.name) {
                ...
                case 'searchByAddressBtn':
                    ...
                    this.props.viewState.searchByNameResult = this.state.cityValue + ' ' + this.state.streetValue + ' پلاک  ' + this.state.streetNumberValue;
                ...
                case 'searchBypostcodeBtn':
                    ...
                    this.props.viewState.searchByNameResult = 'تهران بلوار آسمان پلاک ۱۳۵ واحد ۲ ' + ' کد پستی' + this.state.postcodeValue;
                    ...
                    <If condition={this.props.viewState.myDataIsUploadView}>
                        <div className={Styles.addedData}>
                            ...
                            <If condition={this.props.viewState.isLoadingSearchResult}>
                                <img src={img} className={Styles.img} /><label className={Styles.label} >اتصال به پایگاه داده ثبت احوال </label>
