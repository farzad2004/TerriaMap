    ...
    submit(e) {
        switch (e.target.name) {
            case 'searchByNameBtn':
                setTimeout(function () { this.props.viewState.isSearchByNameClicked = true; }.bind(this), 1000);
                break;
            case 'searchByMelliCodeBtn':
                ...
                this.props.viewState.isResultVisible = true;
                setTimeout(function () { document.getElementById("tablist--data-catalog").getElementsByTagName("button")[0].click() }.bind(this),0.5);
                break;
