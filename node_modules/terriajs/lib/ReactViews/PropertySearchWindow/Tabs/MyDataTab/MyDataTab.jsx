                        ...
                        <div className={Styles.addedData}>
                            ...
                            <If condition={this.props.viewState.searchPropertyByName}>
                                <div>
                                    ...
                                    <button type='button' className={Styles.btn} onClick={this.submitName}>جستجو</button>
                            ...
                            <If condition={this.props.viewState.searchPropertyByMelliCode}>
                                <div>
                                    <label className={Styles.label} htmlFor="melliCodeField" value={this.state.melliCodeValue} onChange={this.handleChange} > کد ملی </label>
