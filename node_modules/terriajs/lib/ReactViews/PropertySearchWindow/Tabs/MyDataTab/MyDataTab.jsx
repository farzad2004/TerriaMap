...
const optionsMelicode = [
    ...
    { value: '1', label: '12323123'},
    { value:'2', label: '23423424'}
]
    ...
    submit(e) {
        switch (e.target.name) {
            case 'searchByNameBtn':
                setTimeout(function () { this.props.viewState.isSearchByNameClicked = true; }.bind(this), 2000);
                break;
            case 'searchByMelliCodeBtn':
                ...
                this.props.viewState.isResultVisible = true;
                setTimeout(function () { document.getElementById("tablist--data-catalog").getElementsByTagName("button")[0].click() }.bind(this),1);
                break;
            case 'searchByAddressBtn':
                this.props.viewState.searchByNameResult =  this.state.cityValue + ' خیابان ' + this.state.streetValue + ' پلاک  ' + this.state.streetNumberValue;
                this.props.viewState.isResultVisible = true;
                 document.getElementById("tablist--data-catalog").getElementsByTagName("button")[0].click() ;
                 break;
            case 'searchBypostcodeBtn':
                console.log("dff");
                this.props.viewState.searchByNameResult = 'تهران خیابان بهشتی پلاک 2 ' + ' کد پستی' + this.state.postcodeValue;
                this.props.viewState.isResultVisible = true;
                setTimeout(function () { document.getElementById("tablist--data-catalog").getElementsByTagName("button")[0].click() }.bind(this), 1);
                break;
            default:
                ...
                <div className={Styles.leftCol}>
                    <If condition={this.props.viewState.myDataIsUploadView}>
                        <div className={Styles.addedData}>
                            ...
                            <Dropdown id='searchProperySelectTypeID' options={options} onChange={this.onSelect} value={options[0]} placeholder="Select an option" />
                            ...
                            <If condition={this.props.viewState.searchPropertyByAddress}>
                                <div>                       
                                    ...
                                    <input className={Styles.field} type='text' name='cityField' value={this.state.cityValue}  defaultValue="تهران" onChange={this.changeRangeMin} />
                                    <label className={Styles.label} htmlFor="streetNameField">خیابان </label>
                                    <input className={Styles.field} type='text' name='streetNameField' value={this.state.streetValue} defaultValue="بهشتی" onChange={this.changeRangeMin} />
                                    <label className={Styles.label} htmlFor="streetNumberField">پلاک </label>
                                    <input className={Styles.field} type='text' name='streetNumberField' value={this.state.streetNumberValue}  defaultValue="۲" onChange={this.changeRangeMin} />                                                 
                            ...
                            <If condition={this.props.viewState.searchPropertyByName}>
                                <div>
                                    ...
                                    <input className={Styles.field} type='text' value={this.state.firstNameValue} defaultValue='داود' name='nameField' onChange={this.handleChange} />
                            ...
                            <If condition={this.props.viewState.searchPropertyByPostCode}>
                                <div>
                                    ...
                                    <input className={Styles.field} type='text' defaultValue="157714671" name='postcodeField' onChange={this.handleChange} />
