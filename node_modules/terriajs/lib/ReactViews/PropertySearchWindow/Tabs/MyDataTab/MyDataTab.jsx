    ...
    submit(e) {
        ...
        switch (e.target.name) {
            case 'searchByNameBtn':
                ...
                this.props.viewState.searchResultInfo = 'اطلاعات اخذ شده از پایگاه داده ثبت احوال ایران';
            ...
            case 'searchByAddressBtn':
                ...
                this.props.viewState.searchByNameResult = 'تهران، خزانه، 38137، خیابان قاضی زاده، خیابان درویش، پلاک 135، واحد 1';
              //((this.state.cityValue + '، ' + this.state.suburbValue + '، ' + this.state.streetValue + '/ پلاک' + //(this.state.streetNumberValue).replace("/ ", "/واحد ")).replace(" /", "،")).replace(" /", "،").replace(" /", "،").replace(" /", "، ");
                this.props.viewState.searchResultInfo = ' اطلاعات اخذ شده از پایگاه داده پست ایران';
