...
import Styles from './propertySearch-window.scss';

const SLIDE_DURATION = 300;
const divStyle = {
    margin: "5px 70px"
};
const PropertySearchWindow = createReactClass({
    displayName: 'PropertySearchWindow',
    ...
    close() {
        this.props.viewState.isResultVisible = false;
        document.getElementById("tablist--my-data").getElementsByTagName("button")[0].click();
        this.props.viewState.isSearchByNameClicked = false;
        this.props.viewState.propertySearchPanelIsVisible = false;
    ...
    isVisible() {
        return !this.props.viewState.useSmallScreenInterface && !this.props.viewState.hideMapUi() && this.props.viewState.propertySearchPanelIsVisible;
    },
    ...
    render() {
        ...
        return visible ? (
            <div className={Styles.modalWrapper}
                 id="property-search-panel-wrapper"
                 aria-hidden={!visible}>
                <div onClick={this.close}
                     id="modal-overlay"
                     className={Styles.modalOverlay}
                     tabIndex="-1"/>
                <div id="propery-search-panel"
                    ...
                    <button type='button'
                        ...
                        className={Styles.btnCloseModal} style={divStyle}
                        title="Initialise Search"
                        data-target="close-modal">
                        جستجوی مجدد
                    </button>
...
module.exports = PropertySearchWindow;
