        ...
        return (
            <ul className={Styles.dataCatalog}>
                ...
                <For each="item" of={items}>
                    {((item.id == "searchResult1" && this.props.viewState.searchPropertyByName) || item.id == "searchResult2" && this.props.viewState.searchPropertyByMelliCode || item.id == "searchResult3" && this.props.viewState.searchPropertyByAddress || item.id == "searchResult4" && this.props.viewState.searchPropertyByPostCode ) && item !== this.props.terria.catalog.userAddedDataGroup &&
