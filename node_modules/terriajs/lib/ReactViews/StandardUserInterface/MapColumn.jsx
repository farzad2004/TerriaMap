...
//import img from "../../../wwwroot/images/logos/boran.jpg";
import imgNcc from "../../../wwwroot/images/logos/Ncc.png";
import imgBohran from "../../../wwwroot/images/logos/bohran.png";
import imgPost from "../../../wwwroot/images/logos/post.png";
import imgSabAhval from "../../../wwwroot/images/logos/sabtahval.png";
import imgSabtAsnad from "../../../wwwroot/images/logos/sabtasnad.png";
import imgShahrdari from "../../../wwwroot/images/logos/shahrdari.png";
                    ...
                    <div className={classNames(Styles.mapCell, Styles.mapCellMap)} ref={this.newMapCell}>
                        ...
                        <If condition={!this.props.viewState.hideMapUi()}>
                            <div className={Styles.logo}>
                                <span>
                                    <a title="سازمان نقشه برداری کشور" target="_blank" href="http://nationalmap.gov.au/renewables/" className={Styles.link}>
                                    <img className={Styles.image} src={imgNcc} 
                                    alt="" />
                                    </a>
                                    <a title="سازمان مدیریت بحران کشور" className={Styles.link} target="_blank" href="https://www.ndmo.ir/Portal/Home/">
                                        <img className={Styles.image} src={imgBohran}
                                        alt="BOHRAN" />
                                    </a>
                                    <a title="پرتال شرکت ملی پست ایران" className={Styles.link} target="_blank" href="http://post.ir/">
                                        <img className={Styles.image} src={imgPost}
                                            alt="POST" />
                                    </a>
                                    <a title="سازمان ثبت احوال کشور" className={Styles.link} target="_blank" href="https://www.sabteahval.ir/">
                                        <img className={Styles.image} src={imgSabAhval}
                                            alt="SABT_AHVAL" />
                                    </a>
                                    <a title="سازمان ثبت اسناد و املاک کشور" className={Styles.link} target="_blank" href="www.ssaa.ir/">
                                        <img className={Styles.image} src={imgSabtAsnad}
                                            alt="SABT_ASNAD" />
                                    </a>
                                    <a title="شهرداری تهران" className={Styles.link} target="_blank" href="http://www.tehran.ir/">
                                        <img className={Styles.image} src={imgShahrdari}
                                            alt="SHAHRDARI" />
                                    </a>
                                </span>
                            </div>
