...
const SettingPanel = createReactClass({
    ...
    render() {
        ...
        return (
            <MenuPanel theme={dropdownTheme} btnTitle="Change view" btnText="نقشه" viewState={this.props.viewState}
                        ...
                        <For each="viewerMode" of={this.props.viewerModes} index="i">
                            <li key={i} className={Styles.listItem}>
                                <button onClick={that.selectViewer.bind(this, i)}
                                        className={classNames(Styles.btnViewer,Styles.FontStyle, {[Styles.isActive]: i === currentViewer})}>
                                    {viewerMode}
                                </button>
                            </li>
                        </For>
