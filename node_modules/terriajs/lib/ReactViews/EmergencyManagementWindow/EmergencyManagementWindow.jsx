...
const ExplorerWindow = createReactClass({
    ...
    close() {
        this.props.viewState.emergencyManagmentPanelIsVisible = false;
    ...
    isVisible() {
        return !this.props.viewState.useSmallScreenInterface && !this.props.viewState.hideMapUi() && this.props.viewState.emergencyManagmentPanelIsVisible;
    },
