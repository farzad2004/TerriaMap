...
export default class ViewState {
    constructor(options) {
        ...
        this.propertySearchPanelIsVisible = false;
        this.emergencyManagmentPanelIsVisible = false;
        this.modalTabIndex = 0;
        this.modalPropertyTabIndex = 0;
        ...
        this.searchPropertyByName = true;
        this.searchPropertyByAddress = false;
        this.searchPropertyByMelliCode = false;
        this.searchPropertyByPostCode = false;
        this.isSearchByNameClicked = false;
        this.isLoadingSearchResult = false;
        this.isLoadingSearchResultPost = false;
        this.isResultVisible = false;
        this.searchByNameResult = "";
        ...
        knockout.track(this, [
            ...
            'propertySearchPanelIsVisible',
            'emergencyManagmentPanelIsVisible',
            'searchPropertyByName',
            'searchPropertyByAddress',
            'searchPropertyByMelliCode',
            'searchPropertyByPostCode',
            'isLoadingSearchResult',
            'isLoadingSearchResultPost',
            'isResultVisible',
            'isSearchByNameClicked',
            'searchByNameResult',
            'searchResultInfo',
            'modalTabIndex',
            'modalPropertyTabIndex',
    ...
    openAddData() {
        ...
        this.modalTabIndex =0;
        this.modalPropertyTabIndex =1;
    }

//This code is added to oepn the search property window while clicking on جستجوی املاک 
    openSearchProperty() {
        this.propertySearchPanelIsVisible = true;
        this.modalTabIndex = 0;
        this.modalPropertyTabIndex = 0;

    }
// this code is added to open the emergency management panel on  clicking مدیریت بحران
    openEmergencyManagement() {
        this.emergencyManagmentPanelIsVisible = true;
        this.modalTabIndex = 0;
        this.modalPropertyTabIndex = 0;
    }
//
