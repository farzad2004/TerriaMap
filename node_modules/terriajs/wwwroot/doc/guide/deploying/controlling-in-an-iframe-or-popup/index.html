...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Controlling in an &lt;iframe&gt; or Popup - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Controlling in an &lt;iframe&gt; or Popup" class="md-nav__link md-nav__link--active">
      Controlling in an &lt;iframe&gt; or Popup
    </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <h1>Controlling in an &lt;iframe&gt; or Popup</h1>
                
                <p>TerriaJS can be configured to accept messages posted to it by its parent window.  This is useful when embedding a TerriaJS app in an iframe and when the parent wants to send more data to the embedded app than can be reasonably included in a URL.</p>
<p>Click <a href="http://terriajs.github.io/embedded-natmap/">here</a> to see a demo, which also sizes the iframe to fill the available space.</p>
<p>First, the TerriaJS app must include a line like this:</p>
<pre><code class="js">updateApplicationOnMessageFromParentWindow(terria, window);
</code></pre>

<p>Then, the parent window can send messages like this:</p>
...
<p>Notice that parent is creating a CSV catalog item with embedded data.  The CSV is only two lines in this case, but in a real application it could be large, much larger than could fit in a URL.</p>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../controlling-with-url-parameters/" title="Controlling with URL Parameters" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../../contributing/" title="Overview" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
