...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <p>This section explains how to deploy and maintain production (and production-ish) versions of TerriaJS applications like TerriaMap.  Before tackling this section, read <a href="../getting-started/">Getting Started</a> to learn how to build and run TerriaMap locally.</p>
<p>Deploying TerriaMap itself:</p>
<ul>
<li><a href="deploying-terriamap/">Deploying TerriaMap.md</a>: General instructions for deploying TerriaMap in almost any environment.</li>
<li><a href="deploying-to-aws/">Deploying to AWS</a>: Deploy TerriaMap to <a href="https://aws.amazon.com/">Amazon Web Services (AWS)</a>.</li>
<li><a href="deploying-with-docker/">Deploying with Docker</a>: Deploy TerriaMap using <a href="https://www.docker.com/">Docker</a>.</li>
</ul>
<p>Deploying other services for use with TerriaJS:</p>
<ul>
<li><a href="setting-up-a-region-mapping-server/">Setting Up a Region Mapping Server</a>: Set up a server for use with TerriaJS's region mapping feature.</li>
<li><a href="setting-up-geoserver/">Setting Up Geoserver</a>: Configure <a href="http://geoserver.org/">GeoServer</a> for effective use with TerriaJS.</li>
</ul>
<p>Using a TerriaMap in other applications:</p>
<ul>
<li><a href="using-as-a-ckan-previewer/">Using as a CKAN Previewer</a>: Use TerriaJS as a previewer for geospatial data in a <a href="http://ckan.org/">CKAN</a> site.</li>
<li><a href="controlling-with-url-parameters/">Controlling with URL Parameters</a>: Control a TerriaJS application by passing it URL parameters.  This is powerful because it enables another site to launch or embed a customized map with little or no code to write.</li>
<li><a href="controlling-in-an-iframe-or-popup/">Controlling in an &lt;iframe&gt; or Popup</a>: Embed a TerriaJS application in iframe or pop it up in a separate window, and control it by posting it cross-window messages.</li>
</ul>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../connecting-to-data/catalog-type-details/why-am-i-special-function/" title="Why Am I Special (function)" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="deploying-terriamap/" title="Deploying TerriaMap" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
