...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Using as a CKAN Previewer - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Using as a CKAN Previewer" class="md-nav__link md-nav__link--active">
      Using as a CKAN Previewer
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#ckan-previewer" title="CKAN previewer" class="md-nav__link">
    CKAN previewer
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#to-create-a-ckan-installation-with-docker" title="To create a CKAN installation with docker" class="md-nav__link">
    To create a CKAN installation with docker
          ...
          <li class="md-nav__item">
  <a href="#to-create-a-ckan-installation-from-source" title="To create a CKAN installation from source" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#to-make-sysadmin-account" title="To make sysadmin account" class="md-nav__link">
    To make sysadmin account
          ...
          <li class="md-nav__item">
  <a href="#to-add-cesium-previewer" title="To add Cesium Previewer" class="md-nav__link">
    ...
    To add Cesium Previewer
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <h1>Using as a CKAN Previewer</h1>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../setting-up-geoserver/" title="Setting Up Geoserver" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../controlling-with-url-parameters/" title="Controlling with URL Parameters" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
