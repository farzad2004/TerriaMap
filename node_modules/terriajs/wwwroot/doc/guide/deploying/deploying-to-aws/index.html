...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Deploying to AWS" class="md-nav__link md-nav__link--active">
      Deploying to AWS
    </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#prerequisites" title="Prerequisites" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#awscli" title="awscli" class="md-nav__link">
    awscli
  </a>
          ...
          <li class="md-nav__item">
  <a href="#aws-credentials" title="AWS credentials" class="md-nav__link">
    AWS credentials
  </a>
  ...
  <a href="#packagejson" title="package.json" class="md-nav__link">
    package.json
        ...
        <li class="md-nav__item">
  <a href="#stackjson" title="stack.json" class="md-nav__link">
    stack.json
  </a>
  ...
  <a href="#deploy" title="Deploy" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#test-stack" title="Test stack" class="md-nav__link">
    Test stack
  </a>
          ...
          <li class="md-nav__item">
  <a href="#update-dns-alias" title="Update DNS alias" class="md-nav__link">
    Update DNS alias
  </a>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../deploying-terriamap/" title="Deploying TerriaMap" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../deploying-with-docker/" title="Deploying with Docker" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
