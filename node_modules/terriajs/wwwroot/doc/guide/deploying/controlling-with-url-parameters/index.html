...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Controlling with URL Parameters - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Controlling with URL Parameters" class="md-nav__link md-nav__link--active">
      Controlling with URL Parameters
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#display-parameters" title="Display parameters" class="md-nav__link">
    Display parameters
  </a>
        ...
        <li class="md-nav__item">
  <a href="#catalog-files-init-files" title="Catalog files (init files)" class="md-nav__link">
    Catalog files (init files)
        ...
        <li class="md-nav__item">
  <a href="#start-data" title="Start data" class="md-nav__link">
    Start data
  </a>
    ...
    Start data
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <h1>Controlling with URL Parameters</h1>
                
                <p>Many aspects of TerriaJS (and hence TerriaMap, NationalMap, and others) can be configured by the end user by passing URL parameters. Combine them like this:</p>
<ul>
<li>The base URL, then a <code>#</code></li>
<li>Then the first parameter</li>
<li>Then repeatedly: a <code>&amp;</code>, and the next parameter</li>
</ul>
<p>For example: <a href="http://nationalmap.gov.au#test&amp;map=2d">http://nationalmap.gov.au#test&amp;map=2d</a></p>
<h3 id="display-parameters">Display parameters</h3>
<table>
<thead>
<tr>
<th>Parameter</th>
...
<td>Don't load the default catalog files for this site.</td>
</tr>
<tr>
<td><code>map=2d</code></td>
<td>Use the 2D (Leaflet) map instead of the default.</td>
</tr>
<tr>
<td><code>map=3d</code></td>
<td>Use the 3D (Cesium) map instead of the default.</td>
</tr>
<tr>
<td><code>hideExplorerPanel=1</code></td>
<td>Collapse the catalog (left side) panel, useful for embedding.</td>
</tr>
<tr>
<td><code>mode=preview</code></td>
<td>Operate in "preview mode", which mostly means not showing a warning if the screen is <code>small</code></td>
</tr>
<tr>
<td><code>share=</code>...</td>
<td>Load a map view previously saved using the "Share" function with URL shortening.</td>
</tr>
<tr>
<td><code>start=</code>...</td>
<td>Load a map view previously saved without URL shortening. The argument is a URL-encoded JSON structure defined using an internal format described below.</td>
</tr>
<tr>
<td><code>&lt;initfile&gt;</code></td>
<td>Load catalog file as described below.</td>
</tr>
</tbody>
</table>
<h3 id="catalog-files-init-files">Catalog files (init files)</h3>
<p>Any unrecognised parameter (eg <code>foo</code>) is treated as the name of a catalog file, loaded from the directory <code>wwwroot/init/foo.json</code>). Multiple catalog files can be loaded this way, and will be combined. Later files can override earlier ones.</p>
<p>Example: <a href="http://nationalmap.gov.au#test">http://nationalmap.gov.au#test</a></p>
<h3 id="start-data">Start data</h3>
<p>The <code>start=</code> parameter essentially embeds an entire catalog file in the URL. The format is:</p>
<pre><code>{
    &quot;version&quot;: &quot;0.0.05&quot;,
    &quot;initSources&quot;: [
        &quot;init/nm.json&quot;,
...
<p>The exact structure changes as features are added. The best way to understand it is:</p>
<ol>
<li>Adjust the view as desired</li>
<li>Generate a share link</li>
<li>URL-decode the share link (using a tool <a href="http://www.url-encode-decode.com/">such as this</a>).</li>
</ol>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../using-as-a-ckan-previewer/" title="Using as a CKAN Previewer" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../controlling-in-an-iframe-or-popup/" title="Controlling in an &lt;iframe&gt; or Popup" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
