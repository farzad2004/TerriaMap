...
<p>This guide explains how to build and run TerriaMap locally.  See <a href="../Deployment">Deployment</a> to learn how to deploy it for use by others.</p>
...
<ul>
<li><a href="https://nodejs.org">Node.js</a> v5.10 or later.  v6.x and v7.x are also known to work, and later major versions are likely to work as well.  You can check your node version by running <code>node --version</code> on the command-line.</li>
<li><a href="https://www.npmjs.com/">npm</a> v3.0 or later.  This is usually installed automatically alongside the above.  You can check your npm version by running <code>npm --version</code>.</li>
</ul>
...
<p>Now that you have a working local build of TerriaMap, you may want to <a href="../Customizing">customize it</a> or <a href="../Deployment">deploy it</a> for others to use.</p>
