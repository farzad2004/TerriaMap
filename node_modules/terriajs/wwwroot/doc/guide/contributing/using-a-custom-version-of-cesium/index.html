...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Using a Custom Version of Cesium - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Using a Custom Version of Cesium" class="md-nav__link md-nav__link--active">
      Using a Custom Version of Cesium
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#working-on-terriajs-and-cesium" title="Working on TerriaJS and Cesium" class="md-nav__link">
    ...
    Committing modifications
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <h1>Using a Custom Version of Cesium</h1>
...
<p>The process of using a custom version of Cesium is much the same as using a custom version of TerriaJS.  See the <a href="../development-environment/#building-a-terriamap-against-a-modified-terriajs">Development Environment</a> for information on setting up and using <code>npmgitdev</code>.  To clone Cesium, do:</p>
...
<p>It is important that you use the <code>terriajs</code> branch of <a href="https://github.com/TerriaJS/cesium">TerriaJS/cesium</a> because it contains important changes to Cesium that are necessary for it to work with TerriaJS.  If you need to use a different branch of Cesium, you will need to merge that branch with the changes in the <code>terriajs</code> branch.</p>
<p>If you run <code>npmgitdev install</code>, make sure that npm hasn't installed a separate version of <code>terriajs-cesium</code> under terriajs:</p>
<pre><code>rm -rf node_modules/terriajs/node_modules/terriajs-cesium
</code></pre>
...
<p>The <code>package.json</code> in the <code>master</code> branch should always point to official releases of <code>terriajs-cesium</code> on npm, NOT GitHub branches.</p>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../setting-up-saucelabs/" title="Setting up Saucelabs" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
