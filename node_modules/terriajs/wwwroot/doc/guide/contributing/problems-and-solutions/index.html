...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Problems and Solutions - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Problems and Solutions" class="md-nav__link md-nav__link--active">
      Problems and Solutions
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#npm-run-hot-hangs-or-other-crazy-things-happen" title="npm run hot hangs, or other crazy things happen" class="md-nav__link">
    ...
    npm run hot hangs, or other crazy things happen
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <h3 id="npm-run-hot-hangs-or-other-crazy-things-happen"><code>npm run hot</code> hangs, or other crazy things happen</h3>
<p>This is usually caused by having two copies of a package, such as a Webpack loader, in different places in your application.  For example, you might have <code>MyApp/node_modules/sass-loader</code> and also <code>MyApp/node_modules/terriajs/node_modules/sass_loader</code>.</p>
<p>This happens <em>all the time</em> if you use <code>npm link</code>, so don't use <code>npm link</code>.  It is flawed model that interferes with npm's ability to de-duplicate modules, leading to problems like this and many others.  Instead, use <a href="https://github.com/TerriaJS/npmgitdev">npmgitdev</a>.  Instructions for installing and using <code>npmgitdev</code> are on the <a href="../development-environment/">Development Environment</a> page.</p>
<p>It may also happen if there are version conflicts between packages, or if npm's deduplication has decided to take the day off for unknown reasons.  When in doubt, run <code>rm -rf node_modules/terriajs/node_modules &amp;&amp; npmgitdev install</code> from your application directory.</p>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../setting-up-saucelabs/" title="Setting up Saucelabs" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
