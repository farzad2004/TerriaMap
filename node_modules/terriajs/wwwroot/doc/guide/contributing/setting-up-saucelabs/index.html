...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Setting up Saucelabs - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Setting up Saucelabs" class="md-nav__link md-nav__link--active">
      Setting up Saucelabs
    </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <h1>Setting up Saucelabs</h1>
                
                <ul>
<li>Get an account from <a href="https://saucelabs.com/open-source">https://saucelabs.com/open-source</a>.</li>
<li>DON'T bother installing any tunnels or any of that nonsense that it tells you to do. This is actually automatically handled by sauce's npm module which is pretty sweet.</li>
<li>Go to "My Account" in saucelabs (bottom left menu) and copy your access key (middle of the page roughly).</li>
<li>Set env variables for SAUCE_USERNAME and SAUCE_ACCESS_KEY using your OS's method for doing that (<code>export</code> in bash) with your sauce username and the access key you just copied.</li>
<li>Run <code>npm install -g karma-cli</code> Without this karma will sort-of work but give you confusing errors.</li>
<li>Run <code>npm start</code> in your <code>terriajs</code> dir in another terminal.</li>
<li>Run <code>gulp test-saucelabs</code> if you have a <code>karma-saucelabs.conf.js</code> file, or run <code>karma start</code> from the TerriaJS directory if you have a <code>karma.config.js</code> file.</li>
</ul>
<p>If you want to narrow down the browsers being run (i.e. only run IE9), you can remove them from <code>karma[-saucelabs].config.js</code> under <code>browsers</code>.</p>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../using-a-custom-version-of-cesium/" title="Using a Custom Version of Cesium" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../problems-and-solutions/" title="Problems and Solutions" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
