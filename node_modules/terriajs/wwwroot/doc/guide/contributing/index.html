...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <p>We're thrilled to have you as a contributor!  This section explains how to set up a development environment for modifying TerriaJS, and how to use that modified version in a TerriaMap.  It also has suggestions for contributing.</p>
<p>For all contributors:</p>
<ul>
<li><a href="development-environment/">Setting up a development environment</a></li>
<li><a href="https://github.com/TerriaJS/terriajs/blob/master/CONTRIBUTING.md">CONTRIBUTING.md</a>: how to submit a pull request. Please read! :)</li>
</ul>
<p>Special cases:</p>
<ul>
<li><a href="setting-up-saucelabs/">Setting up Saucelabs</a>: Creating a local Saucelabs instance for cross-browser testing.</li>
<li><a href="using-a-custom-version-of-cesium/">Using a Custom Version of Cesium</a></li>
</ul>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../deploying/controlling-in-an-iframe-or-popup/" title="Controlling in an &lt;iframe&gt; or Popup" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="development-environment/" title="Development Environment" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
