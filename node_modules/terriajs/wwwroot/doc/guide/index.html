...
<ul>
<li><a href="getting-started/">Getting Started</a>: Quick start guide to building your first TerriaJS application.</li>
<li><a href="customizing/">Customizing</a>: Configure and tweak a TerriaJS application, including skinning and setting up the catalog.</li>
<li><a href="connecting-to-data/">Connecting to Data</a>: Connect TerriaJS to your servers and data.</li>
<li><a href="deploying/">Deploying</a>: Deploy a TerriaJS application in simple and advanced scenarios.</li>
<li><a href="contributing/">Contributing</a>: Add new features to TerriaJS, be part of the TerriaJS development team, set up a development environment, write tests, and perform code reviews.</li>
</ul>
...
<p>It can be viewed at <a href="http://terria.io/Documentation">terria.io/Documentation</a>.</p>
