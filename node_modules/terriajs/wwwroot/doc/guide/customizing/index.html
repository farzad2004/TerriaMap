...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <p>TerriaJS can be extensively customized, often without writing any code.  The catalog and many aspects of the look and feel are controlled by JSON configuration files.</p>
<p>This section explains the various ways to customize a TerriaJS application.  It assumes you have already completed the <a href="../getting-started/">Getting Started</a> section and have a working Terria Map.</p>
<ul>
<li><a href="client-side-config/">Client-side Config</a>: Configure which catalog (init) files to load, the application name and support email address, the branding at the top of the application, disclaimers, keys for Bing Maps and Google Analytics, and more.</li>
<li><a href="initialization-files/">Initialization Files</a>: TerriaJS init files describe the catalog that will be presented to the user, the initial map view, and more.  Init files let you connect TerriaJS to your servers and data.</li>
<li><a href="server-side-config/">Server-side Config</a>: Configure which domains the server will proxy for (to avoid <a href="../connecting-to-data/cross-origin-resource-sharing/">Cross-Origin Resource Sharing (CORS) problems</a>), persistence of sharing data, and more.</li>
<li><a href="skinning/">Skinning</a>: Customize the look and feel of a TerriaJS application.</li>
</ul>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="client-side-config/" title="Client-side Config" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
