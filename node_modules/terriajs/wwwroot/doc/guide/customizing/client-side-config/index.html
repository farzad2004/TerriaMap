...
<html class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs+mkdocs-material#1.0.3">
        ...
        <title>Client-side Config - TerriaJS</title>
...
<div class="md-search" data-md-component="search">
  ...
  <li class="md-nav__item">
    ...
    <a href="./" title="Client-side Config" class="md-nav__link md-nav__link--active">
      Client-side Config
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#intializationurls" title="intializationUrls" class="md-nav__link">
    intializationUrls
  </a>
  ...
  <a href="#parameters" title="parameters" class="md-nav__link">
    parameters
        ...
        <li class="md-nav__item">
  <a href="#advanced-options" title="Advanced options" class="md-nav__link">
    Advanced options
  </a>
    ...
    Advanced options
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <p>The file <code>wwwroot/config.json</code> in TerriaMap contains client-side configuration parameters.</p>
...
<h2 id="intializationurls">intializationUrls</h2>
<p>Each string in the array specifies a single <a href="../initialization-files/">initialization file</a> (catalog) to be loaded by TerriaJS.  The init files are loaded in the order they're specified.</p>
<p>If a string ends with <code>.json</code>, it is assumed to be a complete relative or absolute URL to an init file.  The file may be on an entirely separate web server, but in that case it must be accessible for <a href="../../connecting-to-data/cross-origin-resource-sharing/">Cross-Origin Resource Sharing (CORS)</a>.  It may also be generated by a service rather than being a simple static file.  If the URL is relative, it is relative to the config file.</p>
<p>If the string does not end with <code>.json</code>, such as <code>"foo"</code>, it refers to an init file on the same web server at <code>init/foo.json</code>.  In a TerriaMap directory on your computer, it can be found at <code>wwwroot/init/foo.json</code>.</p>
<h2 id="parameters">parameters</h2>
<p>Specifies various options for configuring TerriaJS:</p>
<table>
<thead>
<tr>
<th>Option</th>
...
<td>TerriaJS uses this name whenever it needs to display the name of the application.</td>
</tr>
<tr>
<td><code>"autoPlay"</code></td>
<td>true to start playing time-dynamic datasets on load, or false to start them paused.</td>
</tr>
<tr>
<td><code>"bingMapsKey"</code></td>
<td>A <a href="https://msdn.microsoft.com/en-us/library/ff428642.aspx">Bing Maps API key</a> used for requesting Bing Maps base maps and using the Bing Maps geocoder for searching. It is your responsibility to request a key and comply with all terms and conditions.</td>
</tr>
<tr>
<td><code>"brandBarElements": [ ]</code></td>
<td>An array of strings of HTML that fill up the top left logo space.</td>
</tr>
<tr>
<td><code>"defaultMaximumShownFeatureInfos"</code></td>
<td>The maximum number of "feature info" boxes that can be displayed when clicking a point. (Default: 100)</td>
</tr>
<tr>
<td><code>"disclaimer": {</code><span><br/>&nbsp;&nbsp;<code>"text": "",</code><br/>&nbsp;&nbsp;<code>"url": ""</code><br/><code>}</code></span></td>
<td>This text will be displayed prominently at the bottom of the map, with a clickable link to the URL.</td>
</tr>
<tr>
<td><code>"feedbackUrl"</code></td>
<td>URL of the service used to send feedback.  If not specified, the "Give Feedback" button will not appear.</td>
</tr>
<tr>
<td><code>"googleAnalyticsKey"</code></td>
<td>A Google API key for <a href="https://analytics.google.com">Google Analytics</a>.  If specified, TerriaJS will send various events about how it's used to Google Analytics.</td>
</tr>
<tr>
<td><code>"googleAnalyticsOptions"</code></td>
<td>Additional options that will be passed to the Google Analytics call.</td>
</tr>
<tr>
<td><code>"printDisclaimer": {</code><span><br/>&nbsp;&nbsp;<code>"text": "",</code><br/>&nbsp;&nbsp;<code>"url": ""</code><br/><code>}</code></span></td>
<td>Same as <code>disclaimer</code>, except only shown in printed views.</td>
</tr>
<tr>
<td><code>"supportEmail"</code></td>
<td>The email address shown when things go wrong.</td>
</tr>
<tr>
<td><code>"mobileDefaultViewerMode"</code></td>
<td>A string specifying the default view mode to load when running on a mobile platform. Options are: <code>"3DTerrain"</code>, <code>"3DSmooth"</code>, <code>"2D"</code>. (Default: <code>"2D"</code>)</td>
</tr>
</tbody>
</table>
<h2 id="advanced-options">Advanced options</h2>
<p>These options only need to be changed in unusual deployments. They define the URLs that are accessed for certain additional services, so must be changed if deploying as a static site, for instance.</p>
<table>
<thead>
<tr>
<th>Option</th>
...
<tbody>
<tr>
<td><code>"conversionServiceBaseUrl"</code></td>
<td>URL of OGR2OGR conversion service (part of TerriaJS-Server).</td>
<td><code>convert/</code></td>
</tr>
<tr>
<td><code>"corsProxyBaseUrl"</code></td>
<td>URL of CORS proxy service (part of TerriaJS-Server)</td>
<td><code>proxy/</code></td>
</tr>
<tr>
<td><code>"proj4ServiceBaseUrl"</code></td>
<td>URL of Proj4 projection lookup service (part of TerriaJS-Server)</td>
<td><code>proj4/</code></td>
</tr>
<tr>
<td><code>"proxyableDomainsUrl"</code></td>
<td>URL of list of domains which the CORS proxy service will allow to be proxied.</td>
<td><code>proxyabledomains/</code></td>
</tr>
<tr>
<td><code>"regionMappingDefinitionsUrl"</code></td>
<td>URL of the JSON file that defines region mapping for CSV files.</td>
<td><code>data/regionMapping.json</code></td>
</tr>
</tbody>
</table>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../initialization-files/" title="Initialization Files" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
