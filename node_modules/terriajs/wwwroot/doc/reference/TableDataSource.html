...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TableDataSource</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TableDataSource</h1>
...
<article>
    ...
    <h4 class="name" id="TableDataSource"><span class="type-signature"></span>new TableDataSource<span class="signature">(tableStructure<span class="signature-attributes">opt</span>, tableStyle<span class="signature-attributes">opt</span>, name<span class="signature-attributes">opt</span>, isUpdating<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A DataSource for table-based data where each row corresponds to a single feature or point - not region-mapped.
Generates Cesium entities for each row.
Displaying the points requires a legend.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>A name to show in the legend if no columns are available.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>isUpdating</code></td>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Is the underlying data going to update? Defaults to false.
                 If true, replaces constant feature properties and description with a CallbackProperty.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line139">line 139</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line107">line 107</a>
    </li></ul></dd>
...
<h4 class="name" id="entities"><span class="type-signature"></span>entities<span class="type-signature"> :EntityCollection</span></h4>




<div class="description">
    <p>Gets the collection of Entity instances.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line119">line 119</a>
    </li></ul></dd>
...
<h4 class="name" id="errorEvent"><span class="type-signature"></span>errorEvent<span class="type-signature"> :CesiumEvent</span></h4>




<div class="description">
    <p>Gets a CesiumEvent that will be raised if an error is encountered during processing.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line149">line 149</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets a value indicating if the data source is currently loading data.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line129">line 129</a>
    </li></ul></dd>
...
<h4 class="name" id="loadingEvent"><span class="type-signature"></span>loadingEvent<span class="type-signature"> :CesiumEvent</span></h4>




<div class="description">
    <p>Gets a CesiumEvent that will be raised when the data source either starts or stops loading.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line159">line 159</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets a human-readable name for this instance.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line96">line 96</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line170">line 170</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line577">line 577</a>
    </li></ul></dd>
...
<div class="description">
    <p>Creates a table structure from the csv provided, and attaches it to this datasource.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Csv-formatted string.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableDataSource.js.html">Models/TableDataSource.js</a>, <a href="Models_TableDataSource.js.html#line222">line 222</a>
    </li></ul></dd>
