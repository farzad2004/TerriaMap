...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: GnafAddressGeocoder</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: GnafAddressGeocoder</h1>
...
<article>
    ...
    <h4 class="name" id="GnafAddressGeocoder"><span class="type-signature"></span>new GnafAddressGeocoder<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Australia-only address converter, which uses the GNAF api to determine lat and long coordinates for a given address.
If TableStructure has address column, adds two new columns: lat and long.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_GnafAddressGeocoder.js.html">Map/GnafAddressGeocoder.js</a>, <a href="Map_GnafAddressGeocoder.js.html#line21">line 21</a>
    </li></ul></dd>
    ...
    <ul>
        <li><a href="AddressGeocoder.html">AddressGeocoder</a></li>
    </ul>
    ...
    <h4 class="name" id="bulkConvertAddresses"><span class="type-signature"></span>bulkConvertAddresses<span class="signature">(tableStructure<span class="signature-attributes">opt</span>, corsProxy<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Convert addresses in miniumum number of calls to the server. When the promise fulfills, the tableStructure has been
updated with new lat and lon columns.</p>
</div>
...
<span class="param-type"><a href="TableStructure.html">TableStructure</a></span>
            ...
            <td class="description last"><p>A tableStructure that contains an address column.</p></td>
        </tr>
...
<span class="param-type"><a href="CorsProxy.html">CorsProxy</a></span>
            ...
            <td class="description last"><p>Proxy for cross origin resource sharing</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="AddressGeocoder.html#bulkConvertAddresses">AddressGeocoder#bulkConvertAddresses</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_GnafAddressGeocoder.js.html">Map/GnafAddressGeocoder.js</a>, <a href="Map_GnafAddressGeocoder.js.html#line33">line 33</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves to an BulkAddressGeocoderResult object.</p>
</div>
