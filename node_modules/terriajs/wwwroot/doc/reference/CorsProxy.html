...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: CorsProxy</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: CorsProxy</h1>
...
<article>
    ...
    <h4 class="name" id="CorsProxy"><span class="type-signature"></span>new CorsProxy<span class="signature">(overrideLoadJson)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Rewrites URLs so that they're resolved via the TerriaJS-Server proxy rather than going direct. This is most useful
...
particularly on time-series data).</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>overrideLoadJson</code></td>
            ...
            <td class="description last"><p>A method for getting JSON from a URL that matches the signature of cesium's Source/Core/loadJson
     module - this is overridable mainly for testing.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line24">line 24</a>
    </li></ul></dd>
...
<h4 class="name" id="alwaysUseProxy"><span class="type-signature"></span>alwaysUseProxy<span class="type-signature"> :boolean</span></h4>




<div class="description">
    <p>Whether the proxy should be used regardless of whether the domain supports CORS or not. This defaults to true
on IE&lt;10.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line58">line 58</a>
    </li></ul></dd>
...
<h4 class="name" id="baseProxyUrl"><span class="type-signature"></span>baseProxyUrl<span class="type-signature"> :String</span></h4>




<div class="description">
    <p>The base URL of the TerriaJS server proxy, to which requests will be appended. In most cases this is the server's
host + '/proxy'.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line35">line 35</a>
    </li></ul></dd>
...
<h4 class="name" id="corsDomains"><span class="type-signature"></span>corsDomains<span class="type-signature"> :Array.&lt;String></span></h4>




<div class="description">
    <p>Domains that are known to support CORS, as set by config files.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line52">line 52</a>
    </li></ul></dd>
...
<h4 class="name" id="isOpenProxy"><span class="type-signature"></span>isOpenProxy<span class="type-signature"> :boolean</span></h4>




<div class="description">
    <p>True if we expect that the proxy will proxy any URL - note that if the server isn't set up to do this, having
this set to true will just result in a lot of failed AJAX calls</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line47">line 47</a>
    </li></ul></dd>
...
<h4 class="name" id="pageIsHttps"><span class="type-signature"></span>pageIsHttps<span class="type-signature"> :boolean</span></h4>




<div class="description">
    <p>Whether the page that Terria is running on is HTTPS. This is relevant because calling an HTTP domain from HTTPS
results in mixed content warnings and going through the proxy is required to get around this.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line64">line 64</a>
    </li></ul></dd>
...
<h4 class="name" id="proxyDomains"><span class="type-signature"></span>proxyDomains<span class="type-signature"> :Array.&lt;String></span></h4>




<div class="description">
    <p>Domains that should be proxied for, as set by config files. Stored as an array of hosts - if a TLD is specified,
subdomains will also be proxied.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line41">line 41</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getURL"><span class="type-signature"></span>getURL<span class="signature">(resource, proxyFlag)</span><span class="type-signature"> &rarr; {String}</span></h4>
...
<div class="description">
    <p>Proxies a URL by appending it to <a href="CorsProxy.html#baseProxyUrl">CorsProxy#baseProxyUrl</a>. Optionally inserts a proxyFlag that will override
the cache headers of the response, allowing for caching to be added where it wouldn't otherwise.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>the URL to potentially proxy</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>proxyFlag</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>the proxy flag to pass - generally this is the length of time that you want to override
      the cache headers with. E.g. '2d' for 2 days.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line142">line 142</a>
    </li></ul></dd>
...
<span class="param-type">String</span>
    ...
    <h4 class="name" id="getURLProxyIfNecessary"><span class="type-signature"></span>getURLProxyIfNecessary<span class="signature">(resource, proxyFlag)</span><span class="type-signature"> &rarr; {String}</span></h4>
...
<div class="description">
    <p>Convenience method that combines <a href="CorsProxy.html#shouldUseProxy">CorsProxy#shouldUseProxy</a> and getURL - if the URL passed needs to be
proxied according to the rules/config of the proxy, this will return a proxied URL, otherwise it will return the
original URL.</p>
<p>{@see CorsProxy#shouldUseProxy}
{@see CorsProxy#getURL}</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line160">line 160</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Either the URL passed in or a proxied URL if it should be proxied.</p>
</div>
...
<span class="param-type">String</span>
    ...
    <h4 class="name" id="init"><span class="type-signature"></span>init<span class="signature">(serverConfig, baseProxyUrl, proxyDomains)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Initialises values with config previously loaded from server. This is the recommended way to use this object as it ensures
the options will be correct for the proxy server it's configured to call, but this can be skipped and the values it
initialises set manually if desired.</p>
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Configuration options retrieved from a ServerConfig object.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>baseProxyUrl</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The base URL to proxy with - this will default to 'proxy/'</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>proxyDomains</code></td>
...
<span class="param-type">Array.&lt;String></span>
            ...
            <td class="description last"><p>Initial value for proxyDomains to which proxyable domains from the server will be appended -
     defaults to an empty array.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line78">line 78</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>A promise that resolves when initialisation is complete.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="shouldUseProxy"><span class="type-signature"></span>shouldUseProxy<span class="signature">(url)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<div class="description">
    <p>Determines if the proxying service should be used to access the given URL, based on our list of
domains we're willing to proxy for and hosts that are known to support CORS.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The url to examine.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_CorsProxy.js.html">Core/CorsProxy.js</a>, <a href="Core_CorsProxy.js.html#line97">line 97</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>true if the proxy should be used, false if not.</p>
</div>
