...
<article>
    ...
    <h4 class="name" id="Clock"><span class="type-signature"></span>new Clock<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Extension of the standard Clock provided by Cesium customised to deal with Terria-level abstractions like
<a href="CatalogItem.html">CatalogItem</a>s.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>see terriajs-cesium/Source/Core/Clock</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Clock.js.html">Models/Clock.js</a>, <a href="Models_Clock.js.html#line14">line 14</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="determineGap"><span class="type-signature"></span>determineGap<span class="signature">(date)</span><span class="type-signature"> &rarr; {TimeInterval}</span></h4>
...
<div class="description">
    <p>Determines whether the passed JulianDate occurs within a gap in the currently tracked <a href="CatalogItem.html">CatalogItem</a>'s
data. If so returns that gap as a TimeInterval, otherwise undefined.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Clock.js.html">Models/Clock.js</a>, <a href="Models_Clock.js.html#line57">line 57</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The gap in the data that the passed date falls within, if one exists.</p>
</div>
...
<span class="param-type">TimeInterval</span>
    ...
    <h4 class="name" id="setCatalogItem"><span class="type-signature"></span>setCatalogItem<span class="signature">(item)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set the <a href="CatalogItem.html">CatalogItem</a> that this clock is currently tracking.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Clock.js.html">Models/Clock.js</a>, <a href="Models_Clock.js.html#line42">line 42</a>
    </li></ul></dd>
