...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_TableStructure.js.html">Map/TableStructure.js</a>, <a href="Map_TableStructure.js.html#line226">line 226</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <h4 class="name" id=".divideValues"><span class="type-signature">(static) </span>divideValues<span class="signature">(numerator, denominator)</span><span class="type-signature"> &rarr; {Array.&lt;Number>}</span></h4>
...
<span class="param-type">Array.&lt;Number></span>
    ...
    <h4 class="name" id=".sumValues"><span class="type-signature">(static) </span>sumValues<span class="signature">(&hellip;The)</span><span class="type-signature"> &rarr; {Array.&lt;Number>}</span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="getFullOptions"><span class="type-signature"></span>getFullOptions<span class="signature">()</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="toArrayWithName"><span class="type-signature"></span>toArrayWithName<span class="signature">()</span><span class="type-signature"> &rarr; {Array}</span></h4>
