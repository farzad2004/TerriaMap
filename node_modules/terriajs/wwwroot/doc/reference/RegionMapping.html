...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RegionMapping</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RegionMapping</h1>
...
<article>
    ...
    <h4 class="name" id="RegionMapping"><span class="type-signature"></span>new RegionMapping<span class="signature">(catalogItem<span class="signature-attributes">opt</span>, tableStructure<span class="signature-attributes">opt</span>, tableStyle<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A DataSource for table-based data.
...
Displaying the points or regions requires a legend.</p>
</div>
...
<span class="param-type"><a href="CatalogItem.html">CatalogItem</a></span>
            ...
            <td class="description last"><p>The CatalogItem instance.</p></td>
        </tr>
...
<span class="param-type"><a href="TableStructure.html">TableStructure</a></span>
            ...
            <td class="description last"><p>The Table Structure instance; defaults to a new one.</p></td>
        </tr>
...
<span class="param-type"><a href="TableStyle.html">TableStyle</a></span>
            ...
            <td class="description last"><p>The table style; defaults to undefined.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line41">line 41</a>
    </li></ul></dd>
...
<h4 class="name" id="changedEvent"><span class="type-signature"></span>changedEvent<span class="type-signature"> :CesiumEvent</span></h4>




<div class="description">
    <p>Gets a CesiumEvent that will be raised when the underlying data changes.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line110">line 110</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the clock settings defined by the loaded data.  If
only static data exists, this value is undefined.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line98">line 98</a>
    </li></ul></dd>
...
<h4 class="name" id="hasActiveTimeColumn"><span class="type-signature"></span>hasActiveTimeColumn<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Gets a Boolean value saying whether the region mapping has a time column.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line204">line 204</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line193">line 193</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a value indicating if the data source is currently loading data.
Whenever loadingData is changed to false, also trigger a redraw.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line122">line 122</a>
    </li></ul></dd>
...
<h4 class="name" id="isPolled"><span class="type-signature"></span>isPolled<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Gets a Boolean value saying whether the region mapping will be updated due to its catalog item being polled.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line216">line 216</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the TableStructure object holding all the data.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line139">line 139</a>
    </li></ul></dd>
...
<h4 class="name" id="tableStyle"><span class="type-signature"></span>tableStyle<span class="type-signature"> :<a href="TableStyle.html">TableStyle</a></span></h4>




<div class="description">
    <p>Gets the TableStyle object showing how to style the data.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line150">line 150</a>
    </li></ul></dd>
...
<div class="description">
    <p>Destroy the object and release resources</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line836">line 836</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="hideImageryLayer"><span class="type-signature"></span>hideImageryLayer<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Explictly hide the imagery layer (if any).</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line244">line 244</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="loadRegionDetails"><span class="type-signature"></span>loadRegionDetails<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Builds a promise which resolves to either:
  undefined if no regions;
  An array of objects with regionProvider, column and disambigColumn properties.
It also caches this object in regionMapping._regionDetails.</p>
<p>The steps involved are:</p>
<ol>
<li>Wait for the data to be ready, if needed. (For loaded tables, this is trivially true, but it might be constructed elsewhere.)</li>
<li>Get the region provider list (asynchronously).</li>
<li>Use this list to find all the possible region identifiers for this table, eg. 'postcode' or 'sa4_code'.
If the user specified a prefered region variable name/type, put this to the front of the list.
Elsewhere, we only offer the user the first region mapping possibility.</li>
<li>Load the region ids of each possible region identifier (asynchronously), eg. ['2001', '2002', ...].</li>
<li>Once all of these are known, cache and return all the details of all the possible region mapping approaches.</li>
</ol>
<p>These steps are sequenced using a series of promise.thens, so that the caller only sees a promise resolving to the end result.</p>
<p>It is safe to call this multiple times, as each asynchronous call returns a cached promise if it exists.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line365">line 365</a>
    </li></ul></dd>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="setRegionColumnType"><span class="type-signature"></span>setRegionColumnType<span class="signature">(regionDetails)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set the region column type.
Currently we only use the first possible region column, and leave any others as they are.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>regionDetails</code></td>
...
<span class="param-type">Array.&lt;Object></span>
            ...
            <td class="description last"><p>The data source's regionDetails array.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionMapping.js.html">Models/RegionMapping.js</a>, <a href="Models_RegionMapping.js.html#line229">line 229</a>
    </li></ul></dd>
