...
<header>
        ...
        <h2>exports</h2>
            ...
            <div class="class-description"><p>Shows disclaimers for <a href="CatalogItem.html">CatalogItem</a>s that are dispatched through Terria#disclaimerEvent - ensures that
disclaimers that share the same key (as specified in CatalogItem#initialMessage#key) are only ever displayed
...
not display any disclaimer and have their successCallback executed immediately.</p>
<p>Also accepts disclaimers with no key, which will always be displayed, and disclaimers with no need for confirmation
(as specified by CatalogItem#initialMessage#confirmation), which will have their successCallback executed
immediately as the message is shown.</p>
<p>Note that this is not for displaying a general disclaimer on startup.</p></div>
...
<article>
    ...
    <h4 class="name" id=".exports"><span class="type-signature"></span>new exports<span class="signature">(terria, viewState)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The <a href="Terria.html">Terria</a> instance to use.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>the viewstate to manipulate in order to display notifications.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_DisclaimerHandler.js.html">ReactViewModels/DisclaimerHandler.js</a>, <a href="ReactViewModels_DisclaimerHandler.js.html#line24">line 24</a>
    </li></ul></dd>
...
<h4 class="name" id="featureInfoPanelIsCollapsed"><span class="type-signature"></span>featureInfoPanelIsCollapsed<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Gets or sets a value indicating whether the feature info panel is collapsed.
When it's collapsed, only the title bar is visible.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_ViewState.js.html">ReactViewModels/ViewState.js</a>, <a href="ReactViewModels_ViewState.js.html#line56">line 56</a>
    </li></ul></dd>
...
<h4 class="name" id="featureInfoPanelIsVisible"><span class="type-signature"></span>featureInfoPanelIsVisible<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Gets or sets a value indicating whether the feature info panel is visible.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_ViewState.js.html">ReactViewModels/ViewState.js</a>, <a href="ReactViewModels_ViewState.js.html#line49">line 49</a>
    </li></ul></dd>
...
<h4 class="name" id="feedbackFormIsVisible"><span class="type-signature"></span>feedbackFormIsVisible<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Gets or sets a value indicating whether the feedback form is visible.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_ViewState.js.html">ReactViewModels/ViewState.js</a>, <a href="ReactViewModels_ViewState.js.html#line70">line 70</a>
    </li></ul></dd>
...
<h4 class="name" id="firstTimeAddingData"><span class="type-signature"></span>firstTimeAddingData<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>True if this is (or will be) the first time the user has added data to the map.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_ViewState.js.html">ReactViewModels/ViewState.js</a>, <a href="ReactViewModels_ViewState.js.html#line62">line 62</a>
    </li></ul></dd>
...
<h4 class="name" id="useSmallScreenInterface"><span class="type-signature"></span>useSmallScreenInterface<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Gets or sets a value indicating whether the small screen (mobile) user interface should be used.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_ViewState.js.html">ReactViewModels/ViewState.js</a>, <a href="ReactViewModels_ViewState.js.html#line43">line 43</a>
    </li></ul></dd>
...
<header>
        ...
        <h2>exports</h2>
            ...
            <div class="class-description"><p>Root of a global view model. Presumably this should get nested as more stuff goes into it. Basically this belongs to
the root of the UI and then it can choose to pass either the whole thing or parts down as props to its children.</p></div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViewModels_ViewState.js.html">ReactViewModels/ViewState.js</a>, <a href="ReactViewModels_ViewState.js.html#line12">line 12</a>
    </li></ul></dd>
