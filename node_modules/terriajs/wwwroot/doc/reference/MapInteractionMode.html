...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: MapInteractionMode</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: MapInteractionMode</h1>
...
<article>
    ...
    <h4 class="name" id="MapInteractionMode"><span class="type-signature"></span>new MapInteractionMode<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A mode for interacting with the map.</p>
</div>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>The function to invoke if the user cancels the interaction mode.  The cancel button will
                                     only appear if this property is specified.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The message to display over the map while the interaction mode is active.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line18">line 18</a>
    </li></ul></dd>
...
<h4 class="name" id="buttonText"><span class="type-signature"></span>buttonText<span class="type-signature"> :String</span></h4>




<div class="description">
    <p>Set the text of the button for the dialog the message is displayed on.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line45">line 45</a>
    </li></ul></dd>
...
<h4 class="name" id="customUi"><span class="type-signature"></span>customUi<span class="type-signature"> :Any</span></h4>




<div class="description">
    <p>Gets or sets the details of a custom user interface for this map interaction mode. This property is not used by
the <code>MapInteractionMode</code> itself, so it can be anything that is suitable for the user interface. In the standard
React-based user interface included with TerriaJS, this property is a function that is called with no parameters
and is expected to return a React component.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line33">line 33</a>
    </li></ul></dd>
...
<h4 class="name" id="drawRectangle"><span class="type-signature"></span>drawRectangle<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>Determines whether a rectangle will be requested from the user rather than a set of pickedFeatures.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line57">line 57</a>
    </li></ul></dd>
...
<h4 class="name" id="onCancel"><span class="type-signature"></span>onCancel<span class="type-signature"> :function</span></h4>




<div class="description">
    <p>Gets or sets a callback that is invoked when the user cancels the interaction mode.  If this property is undefined,
the interaction mode cannot be canceled.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line24">line 24</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line51">line 51</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets the html formatted message displayed on the map when in this mode.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_MapInteractionMode.js.html">Models/MapInteractionMode.js</a>, <a href="Models_MapInteractionMode.js.html#line39">line 39</a>
    </li></ul></dd>
