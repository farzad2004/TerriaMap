...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RegionTypeParameter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RegionTypeParameter</h1>
...
<article>
    ...
    <h4 class="name" id="RegionTypeParameter"><span class="type-signature"></span>new RegionTypeParameter<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A parameter that specifies a type of region.</p>
</div>
...
<span class="param-type">String</span>
        ...
        <tr>
                ...
                <td class="name"><code>validRegionTypes</code></td>
...
<span class="param-type">Array.&lt;String></span>
            ...
            <td class="description last"><p>The region types from which this RegionTypeParameter selects.  If this parameter is not specified, all region types
                                             known to <a href="Terria.html">Terria</a> may be selected.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionTypeParameter.js.html">Models/RegionTypeParameter.js</a>, <a href="Models_RegionTypeParameter.js.html#line28">line 28</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line126">line 126</a>
    </li></ul></dd>
...
<div class="description">
    <p>A converter that can be used to convert this parameter for use with a <a href="CatalogFunction.html">CatalogFunction</a>.
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line79">line 79</a>
    </li></ul></dd>
...
<h4 class="name" id="defaultValue"><span class="type-signature"></span>defaultValue<span class="type-signature"> :<a href="RegionProvider.html">RegionProvider</a></span></h4>




<div class="description">
    <p>Gets the default region provider if the user has not specified one.  If region-mapped data
is loaded on the map, this property returns the <a href="RegionProvider.html">RegionProvider</a> of the topmost
region-mapped catalog item.  Otherwise, it returns the first region provider.  If the
parameter has not yet been loaded, this property returns undefined.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionTypeParameter.js.html">Models/RegionTypeParameter.js</a>, <a href="Models_RegionTypeParameter.js.html#line87">line 87</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line65">line 65</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line137">line 137</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line53">line 53</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line72">line 72</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line59">line 59</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionTypeParameter.js.html">Models/RegionTypeParameter.js</a>, <a href="Models_RegionTypeParameter.js.html#line67">line 67</a>
    </li></ul></dd>
...
<h4 class="name" id="value"><span class="type-signature"></span>value<span class="type-signature"> :<a href="RegionProvider.html">RegionProvider</a></span></h4>




<div class="description">
    <p>Gets or sets the value of this parameter.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionTypeParameter.js.html">Models/RegionTypeParameter.js</a>, <a href="Models_RegionTypeParameter.js.html#line73">line 73</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".resolveRegionProvider"><span class="type-signature">(static) </span>resolveRegionProvider<span class="signature">(regionProviderOrParameter)</span><span class="type-signature"> &rarr; {<a href="RegionProvider.html">RegionProvider</a>}</span></h4>
...
<div class="description">
    <p>Resolves value that may be either a <a href="RegionProvider.html">RegionProvider</a> or a <a href="RegionTypeParameter.html">RegionTypeParameter</a>
to a <a href="RegionProvider.html">RegionProvider</a>.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>regionProviderOrParameter</code></td>
...
<span class="param-type"><a href="RegionTypeParameter.html">RegionTypeParameter</a></span>
            ...
            <td class="description last"><p>The region provider or parameter.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionTypeParameter.js.html">Models/RegionTypeParameter.js</a>, <a href="Models_RegionTypeParameter.js.html#line49">line 49</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>If <code>regionProviderOrParameter</code> is a <a href="RegionProvider.html">RegionProvider</a>, that value is returned.  If it is a
        <a href="RegionTypeParameter.html">RegionTypeParameter</a>, the value of the parameter is returned.
        The return value may be undefined if <code>regionProviderOrParameter</code> is undefined, or if the value of the
        region type parameter is undefined.</p>
</div>
...
<span class="param-type"><a href="RegionProvider.html">RegionProvider</a></span>
    ...
    <h4 class="name" id="formatValueAsString"><span class="type-signature"></span>formatValueAsString<span class="signature">(value)</span><span class="type-signature"> &rarr; {String}</span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Value to format as string.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_FunctionParameter.js.html">Models/FunctionParameter.js</a>, <a href="Models_FunctionParameter.js.html#line212">line 212</a>
    </li></ul></dd>
...
<span class="param-type">String</span>
    ...
    <h4 class="name" id="getAllRegionTypes"><span class="type-signature"></span>getAllRegionTypes<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;Array.&lt;<a href="RegionProvider.html">RegionProvider</a>>>}</span></h4>
...
<div class="description">
    <p>Gets all list of region types that may be selected for this parameter.
Also caches the promise in this._regionProviderPromise, and the promise result in
this._regionProviderList.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_RegionTypeParameter.js.html">Models/RegionTypeParameter.js</a>, <a href="Models_RegionTypeParameter.js.html#line123">line 123</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;Array.&lt;<a href="RegionProvider.html">RegionProvider</a>>></span>
