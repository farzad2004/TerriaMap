...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: GnafSearchProviderViewModel</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: GnafSearchProviderViewModel</h1>
...
<header>
        ...
        <h2>GnafSearchProviderViewModel</h2>
...
<article>
    ...
    <h4 class="name" id="GnafSearchProviderViewModel"><span class="type-signature"></span>new GnafSearchProviderViewModel<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Search provider that uses the Data61 Elastic Search GNAF service to look up addresses.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>options.gnafApi</code></td>
            ...
            <td class="description last"><p>The GnafApi object to query - if none is provided one will be created using terria.corsProxy
     and the default settings.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>options.flightDurationSeconds</code></td>
            ...
            <td class="description last"><p>The number of seconds for the flight animation when zooming to new results.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_GnafSearchProviderViewModel.js.html">ViewModels/GnafSearchProviderViewModel.js</a>, <a href="ViewModels_GnafSearchProviderViewModel.js.html#line24">line 24</a>
    </li></ul></dd>
