...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: LegendHelper</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: LegendHelper</h1>
...
<article>
    ...
    <h4 class="name" id="LegendHelper"><span class="type-signature"></span>new LegendHelper<span class="signature">(tableColumn, tableStyle<span class="signature-attributes">opt</span>, regionProvider<span class="signature-attributes">opt</span>, name<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Legends for table columns depend on both the table style and the selected column.
This class brings the two together to generate a legend.
Its key output is legendUrl.</p>
</div>
...
<span class="param-type"><a href="TableColumn.html">TableColumn</a></span>
            ...
            <td class="description last"><p>The column whose values inform the legend.</p></td>
        </tr>
...
<span class="param-type"><a href="TableStyle.html">TableStyle</a></span>
            ...
            <td class="description last"><p>The styling for the table.</p></td>
        </tr>
...
<span class="param-type"><a href="RegionProvider.html">RegionProvider</a></span>
            ...
            <td class="description last"><p>The region provider, if region mapped. Used if no table column set.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>A name used in the legend if no active column is selected.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendHelper.js.html">Models/LegendHelper.js</a>, <a href="Models_LegendHelper.js.html#line49">line 49</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getColorArrayFromValue"><span class="type-signature"></span>getColorArrayFromValue<span class="signature">(value<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Array.&lt;Number>}</span></h4>
...
<div class="description">
    <p>Maps an absolute value to a color array, based on the legend.</p>
</div>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The absolute value.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendHelper.js.html">Models/LegendHelper.js</a>, <a href="Models_LegendHelper.js.html#line308">line 308</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The color, as an array [r, g, b, a].
        If there is no table column selected, use a random colour.
        If the value is null, use the nullColor.
        If no value is provided, or no color bins are defined, use the nullColor.</p>
</div>
...
<span class="param-type">Array.&lt;Number></span>
    ...
    <h4 class="name" id="getColorFromValue"><span class="type-signature"></span>getColorFromValue<span class="signature">(value<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Color}</span></h4>
...
<div class="description">
    <p>Maps an absolute value to a Color, based on the legend.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendHelper.js.html">Models/LegendHelper.js</a>, <a href="Models_LegendHelper.js.html#line341">line 341</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The color. If no value is provided, uses a default color.</p>
</div>
...
<span class="param-type">Color</span>
    ...
    <h4 class="name" id="getScaleFromValue"><span class="type-signature"></span>getScaleFromValue<span class="signature">(value<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Number}</span></h4>
...
<div class="description">
    <p>Maps an absolute value to a scale, based on tableColumnStyle.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendHelper.js.html">Models/LegendHelper.js</a>, <a href="Models_LegendHelper.js.html#line287">line 287</a>
    </li></ul></dd>
...
<span class="param-type">Number</span>
    ...
    <h4 class="name" id="legendUrl"><span class="type-signature"></span>legendUrl<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="LegendUrl.html">LegendUrl</a>}</span></h4>
...
<div class="description">
    <p>Returns the legendUrl for this legend.  Can be called directly after instantiation.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendHelper.js.html">Models/LegendHelper.js</a>, <a href="Models_LegendHelper.js.html#line257">line 257</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The Legend URL object for the legend, with its url being a base64-encoded PNG.</p>
</div>
