...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: LeafletDragPoints</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: LeafletDragPoints</h1>
...
<article>
    ...
    <h4 class="name" id="LeafletDragPoints"><span class="type-signature"></span>new LeafletDragPoints<span class="signature">(terria, pointMovedCallback)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>For letting user drag existing points in Leaflet ViewerMode only.</p>
</div>
...
<span class="param-type"><a href="Terria.html">Terria</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>pointMovedCallback</code></td>
...
<span class="param-type"><a href="global.html#PointMovedCallback">PointMovedCallback</a></span>
            ...
            <td class="description last"><p>A function that is called when a point is moved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line22">line 22</a>
    </li></ul></dd>
...
<h4 class="name" id="_draggableObjects"><span class="type-signature"></span>_draggableObjects<span class="type-signature"> :<a href="CustomDataSource.html">CustomDataSource</a></span></h4>




<div class="description">
    <p>List of entities that can be dragged, which is populated with user-created points only.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line38">line 38</a>
    </li></ul></dd>
...
<h4 class="name" id="_dragInProgress"><span class="type-signature"></span>_dragInProgress<span class="type-signature"> :Bool</span></h4>




<div class="description">
    <p>Whether user is currently dragging point.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line44">line 44</a>
    </li></ul></dd>
...
<h4 class="name" id="_pointMovedCallback"><span class="type-signature"></span>_pointMovedCallback<span class="type-signature"> :<a href="global.html#PointMovedCallback">PointMovedCallback</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line32">line 32</a>
    </li></ul></dd>
...
<h4 class="name" id="dragCount"><span class="type-signature"></span>dragCount<span class="type-signature"> :Number</span></h4>




<div class="description">
    <p>For determining whether a drag has just occurred, to avoid deleting a point at the end of the drag.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line50">line 50</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="_onMouseDownOnPoint"><span class="type-signature"></span>_onMouseDownOnPoint<span class="signature">(entity)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Function that is called when the user clicks and holds on a point that was previously drawn.</p>
</div>
...
<span class="param-type">Entity</span>
            ...
            <td class="description last"><p>The entity that user mouse downs on.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line75">line 75</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="_onMouseMove"><span class="type-signature"></span>_onMouseMove<span class="signature">(move)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Function that is called when the mouse moves.</p>
</div>
...
<span class="param-type">Leaflet.MouseEvent</span>
            ...
            <td class="description last"><p>Information about the move such as the final position of the mouse.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line99">line 99</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="_onMouseUp"><span class="type-signature"></span>_onMouseUp<span class="signature">(e)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Function that is called when the user releases the mousedown click.</p>
</div>
...
<span class="param-type">Leaflet.MouseEvent</span>
            ...
            <td class="description last"><p>Information about where the event occurred.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line114">line 114</a>
    </li></ul></dd>
...
<div class="description">
    <p>A clean up function to call when destroying the object.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line136">line 136</a>
    </li></ul></dd>
...
<div class="description">
    <p>Set up the drag point helper so that attempting to drag a point will move the point.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line56">line 56</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="updateDraggableObjects"><span class="type-signature"></span>updateDraggableObjects<span class="signature">(entities)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Update the list of draggable objects with a new list of entities that are able to be dragged. We are only interested
in entities that the user has drawn.</p>
</div>
...
<span class="param-type"><a href="CustomDataSource.html">CustomDataSource</a></span>
            ...
            <td class="description last"><p>Entities that user has drawn on the map.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletDragPoints.js.html">Map/LeafletDragPoints.js</a>, <a href="Map_LeafletDragPoints.js.html#line129">line 129</a>
    </li></ul></dd>
