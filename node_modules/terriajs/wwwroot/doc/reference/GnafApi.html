...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: GnafApi</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: GnafApi</h1>
...
<article>
    ...
    <h4 class="name" id="GnafApi"><span class="type-signature"></span>new GnafApi<span class="signature">(corsProxy, overrideUrl<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Simple JS Api for the Data61 Lucene GNAF service.</p>
</div>
...
<span class="param-type"><a href="CorsProxy.html">CorsProxy</a></span>
            ...
            <td class="description last"><p>CorsProxy to use to determine whether calls need to go through the terria proxy.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>overrideUrl</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The URL to use to query the service - will default if not provided.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_GnafApi.js.html">Models/GnafApi.js</a>, <a href="Models_GnafApi.js.html#line22">line 22</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="bulkGeoCode"><span class="type-signature"></span>bulkGeoCode<span class="signature">(searchTermList, rectangle<span class="signature-attributes">opt</span>, batchSize<span class="signature-attributes">opt</span>, maxSimultaneousRequests<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Bulk geocodes in batches with a list of plain-text address. Returns results along with their scores.</p>
<p>If a bounding box is provided, this is used and no results will be returned from outside the bounding box.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>searchTermList</code></td>
...
<span class="param-type">Array</span>
            ...
            <td class="description last"><p>A list of strings representing the addresses to geocode</p></td>
        </tr>
...
<span class="param-type">Rectangle</span>
            ...
            <td class="description last"><p>An optional rectangle describing a box to search within. If this is not provided then
     everywhere is searched.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Maximum number of addresses in each request.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>maxSimultaneousRequests</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Maximum number of requests submitted at one time.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_GnafApi.js.html">Models/GnafApi.js</a>, <a href="Models_GnafApi.js.html#line71">line 71</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves when the search is done.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="geoCode"><span class="type-signature"></span>geoCode<span class="signature">(searchTerm, rectangle<span class="signature-attributes">opt</span>, maxResults<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Geocodes a plain-text address. Returns results along with their scores.</p>
<p>If a bounding box is provided, this is queried, and all results that are returned must lie within the bounding box.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The address to geocode</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The maximum number of results to return - defaults to 10.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_GnafApi.js.html">Models/GnafApi.js</a>, <a href="Models_GnafApi.js.html#line38">line 38</a>
    </li></ul></dd>
