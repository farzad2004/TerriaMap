...
<article>
    ...
    <h4 class="name" id="VariableConcept"><span class="type-signature"></span>new VariableConcept<span class="signature">(name, options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The display name of this variable.</p></td>
        </tr>
...
<span class="param-type"><a href="Concept.html">Concept</a></span>
            ...
            <td class="description last"><p>The parent of this variable; if not parent.allowMultiple, parent.toggleActiveItem(variable) is called when toggling on.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The string description of the color of this variable, if any.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The id of this variable; defaults to the name (via the parent class Concept).</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Whether this variable is visible in the NowViewing tab (defaults to True).</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_VariableConcept.js.html">Map/VariableConcept.js</a>, <a href="Map_VariableConcept.js.html#line26">line 26</a>
    </li></ul></dd>
