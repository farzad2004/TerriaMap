...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TerriaError</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TerriaError</h1>
...
<article>
    ...
    <h4 class="name" id="TerriaError"><span class="type-signature"></span>new TerriaError<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Represents an error that occurred in a TerriaJS module, especially an asynchronous one that cannot be raised
by throwing an exception because no one would be able to catch it.</p>
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The object raising the error.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>A short title describing the error.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>A detailed message describing the error.  This message may be HTML and it should be sanitized before display to the user.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_TerriaError.js.html">Core/TerriaError.js</a>, <a href="Core_TerriaError.js.html#line19">line 19</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a metailed message describing the error.  This message may be HTML and it should be sanitized before display to the user.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_TerriaError.js.html">Core/TerriaError.js</a>, <a href="Core_TerriaError.js.html#line36">line 36</a>
    </li></ul></dd>
...
<h4 class="name" id="raisedToUser"><span class="type-signature"></span>raisedToUser<span class="type-signature"> :Boolean</span></h4>




<div class="description">
    <p>True if the user has seen this error; otherwise, false.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_TerriaError.js.html">Core/TerriaError.js</a>, <a href="Core_TerriaError.js.html#line43">line 43</a>
    </li></ul></dd>
...
<h4 class="name" id="sender"><span class="type-signature"></span>sender<span class="type-signature"> :Object</span></h4>




<div class="description">
    <p>Gets or sets the object that raised the error.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_TerriaError.js.html">Core/TerriaError.js</a>, <a href="Core_TerriaError.js.html#line24">line 24</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a short title describing the error.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Core_TerriaError.js.html">Core/TerriaError.js</a>, <a href="Core_TerriaError.js.html#line30">line 30</a>
    </li></ul></dd>
