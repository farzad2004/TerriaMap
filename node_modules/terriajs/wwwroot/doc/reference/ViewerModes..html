...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ViewerModes.</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ViewerModes.</h1>
...
<article>
    ...
    <h4 class="name" id="ViewerModes."><span class="type-signature"></span>new ViewerModes.<span class="signature">(terria, pointMovedCallback)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>For letting user drag existing points, altering their position without creating or destroying them. Works for all</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_DragPoints.js.html">Map/DragPoints.js</a>, <a href="Map_DragPoints.js.html#line15">line 15</a>
    </li></ul></dd>
