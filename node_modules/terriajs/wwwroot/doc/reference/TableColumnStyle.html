...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TableColumnStyle</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TableColumnStyle</h1>
...
<article>
    ...
    <h4 class="name" id="TableColumnStyle"><span class="type-signature"></span>new TableColumnStyle<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A set of properties that define how a table column should be displayed.
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The values of the properties of the new instance.</p>
                <h6>Properties</h6>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>minDisplayValue</code></td>
...
<span class="param-type">Float</span>
            ...
            <td class="description last"><p>All data values less than or equal to this are considered equal for the purpose of display.</p></td>
        </tr>
...
<span class="param-type">Float</span>
            ...
            <td class="description last"><p>Minimum y value to display in charts; if not specified, minimum data value will be used.</p></td>
        </tr>
...
<span class="param-type">Float</span>
            ...
            <td class="description last"><p>Maximum y value to display in charts; if not specified, maximum data value will be used.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>maxDisplayValue</code></td>
...
<span class="param-type">Float</span>
            ...
            <td class="description last"><p>All data values reater than or equal to this are considered equal for the purpose of display.</p></td>
        </tr>
...
<span class="param-type">Float</span>
            ...
            <td class="description last"><p>Display duration.</p></td>
        </tr>
...
<span class="param-type">Array</span>
            ...
            <td class="description last"><p>Values to replace with zero, eg. ['-', null] will replace '-' and empty values with 0.</p></td>
        </tr>
...
<span class="param-type">Array</span>
            ...
            <td class="description last"><p>Values to replace with null, eg. ['na', 'NA'] will replace these values with null.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>nullColor</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The css string for the color with which to display null values.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>nullLabel</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The legend label for null values.</p></td>
        </tr>
...
<span class="param-type">Float</span>
            ...
            <td class="description last"><p>The size of each point or billboard.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>scaleByValue</code></td>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Should points and billboards representing each feature be scaled by the size of their data variable?</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>clampDisplayValue</code></td>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Display values that fall outside the display range as min and max colors.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>A string representing an image to display at each point, for lat-long datasets.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>An object of { &quot;myCol&quot;: &quot;My column&quot; } properties, defining which columns get displayed in feature info boxes
                and what label is used instead of the column's actual name.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Override color for column for charts.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>colorBins</code></td>
...
<span class="param-type">Array.&lt;Number></span>
            ...
            <td class="description last"><p>Either the number of discrete colours that a color gradient should be quantised into (ie. an integer), or
                an array of values specifying the boundaries between the color bins.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>colorBinMethod</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The method for quantising colors: &quot;auto&quot; (default), &quot;ckmeans&quot;, &quot;quantile&quot; or &quot;none&quot; (equivalent to colorBins: 0).</p></td>
        </tr>
...
<span class="param-type">Array</span>
            ...
            <td class="description last"><p>Gets or sets a string or <a href="global.html#ColorMap">ColorMap</a> array, specifying how to map values to colors.  Setting this property sets
                colorPalette to undefined.  If this property is a string, it specifies a list of CSS colors separated by hyphens (-),
                and the colors are evenly spaced over the range of values.  For example, &quot;red-white-hsl(240,50%,50%)&quot;.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Gets or sets the <a href="http://colorbrewer2.org/">ColorBrewer</a> palette to use when mapping values to colors.  Setting this
                property sets colorMap to undefined.  This property is ignored if colorMap is defined.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>legendTicks</code></td>
...
<span class="param-type">Integer</span>
            ...
            <td class="description last"><p>How many horizontal ticks to draw on the generated color ramp legend, not counting the top or bottom.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Display name for this column.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>legendName</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Display name for this column to use for the legend (defaults to the column name).</p></td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The variable type of this column. Should be one of the keys of VarType (case-insensitive), eg. 'ENUM', 'SCALAR', 'TIME'.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Display units for this column. Currently only displayed in charts.</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Is this column active?</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TableColumnStyle.js.html">Models/TableColumnStyle.js</a>, <a href="Models_TableColumnStyle.js.html#line52">line 52</a>
    </li></ul></dd>
