...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TimeSeriesStack</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TimeSeriesStack</h1>
...
<article>
    ...
    <h4 class="name" id="TimeSeriesStack"><span class="type-signature"></span>new TimeSeriesStack<span class="signature">(clock)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Manages a stack of all the time series layers currently being shown and makes sure the clock provided is always tracking
the highest one. When the top-most layer is disabled, the clock will track the next highest in the stack. Provides access
to the current top layer so that can be displayed to the user.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The clock that should track the highest layer.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TimeSeriesStack.js.html">Models/TimeSeriesStack.js</a>, <a href="Models_TimeSeriesStack.js.html#line16">line 16</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addLayerToTop"><span class="type-signature"></span>addLayerToTop<span class="signature">(item)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Adds the supplied <a href="CatalogItem.html">CatalogItem</a> to the top of the stack. If the item is already in the stack, it will be moved
rather than added twice.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TimeSeriesStack.js.html">Models/TimeSeriesStack.js</a>, <a href="Models_TimeSeriesStack.js.html#line51">line 51</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="removeLayer"><span class="type-signature"></span>removeLayer<span class="signature">(item;)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Removes a layer from the stack, no matter what it's location. If the layer is currently at the top, the value of
TimeSeriesStack#topLayer will change.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_TimeSeriesStack.js.html">Models/TimeSeriesStack.js</a>, <a href="Models_TimeSeriesStack.js.html#line65">line 65</a>
    </li></ul></dd>
