...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: CustomComponentType</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: CustomComponentType</h1>
...
<article>
    ...
    <h4 class="name" id="CustomComponentType"><span class="type-signature"></span>new CustomComponentType<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Represents a custom component type, eg. <chart>.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The component's name, eg. 'chart'.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets the custom attributes for this tag, eg. [&quot;src-preview&quot;].
Used so that when the user-supplied html is sanitized, these attributes are not stripped.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line35">line 35</a>
    </li></ul></dd>
...
<h4 class="name" id="furtherProcessing"><span class="type-signature"></span>furtherProcessing<span class="type-signature"> :Array.&lt;Object></span></h4>




<div class="description">
    <p>Gets or sets an array of objects with additional processNode and shouldProcessNode functions, as above.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line47">line 47</a>
    </li></ul></dd>
...
<h4 class="name" id="isCorresponding"><span class="type-signature"></span>isCorresponding<span class="type-signature"> :<a href="CustomComponentType.html#~isCorresponding">CustomComponentType~isCorresponding</a></span></h4>




<div class="description">
    <p>Gets or sets a function which checks a ReactComponent and returns a Boolean indicating if that react component
corresponds to this type.
&quot;Correspondence&quot; is whatever the component wants it to be. It is used by CustomComponents.find.
CustomComponents.find is used by the feature info template to find if any custom components self-update.</p>
</div>
...
<span class="param-type"><a href="CustomComponentType.html#~isCorresponding">CustomComponentType~isCorresponding</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line56">line 56</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets the tag name, eg. &quot;chart&quot;. This is converted to lower case.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line28">line 28</a>
    </li></ul></dd>
...
<h4 class="name" id="processNode"><span class="type-signature"></span>processNode<span class="type-signature"> :<a href="CustomComponentType.html#~processNode">CustomComponentType~processNode</a></span></h4>




<div class="description">
    <p>Gets or sets a function which is called when an element of this custom component is created.</p>
</div>
...
<span class="param-type"><a href="CustomComponentType.html#~processNode">CustomComponentType~processNode</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line41">line 41</a>
    </li></ul></dd>
...
<h4 class="name" id="selfUpdateSeconds"><span class="type-signature"></span>selfUpdateSeconds<span class="type-signature"> :<a href="CustomComponentType.html#~selfUpdateSeconds">CustomComponentType~selfUpdateSeconds</a></span></h4>




<div class="description">
    <p>Gets or sets a function which checks a ReactComponent and returns an integer if it both
contains this custom component type, and that component would self-update (eg. from a &quot;poll-seconds&quot; attribute).</p>
</div>
...
<span class="param-type"><a href="CustomComponentType.html#~selfUpdateSeconds">CustomComponentType~selfUpdateSeconds</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line63">line 63</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="~isCorresponding"><span class="type-signature"></span>isCorresponding<span class="signature">(reactComponent)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>reactComponent</code></td>
...
<span class="param-type">ReactComponent</span>
            ...
            <td class="description last"><p>This react component.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line78">line 78</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Does the given react component correspond to this custom component type?</p>
</div>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="~processNode"><span class="type-signature"></span>processNode<span class="signature">(context, node, children)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A function passed to html-to-react's processingInstructions.</p>
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Context for the custom component.</p>
                <h6>Properties</h6>
...
<span class="param-type"><a href="CatalogMember.html">CatalogMember</a></span>
            ...
            <td class="description last"><p>The catalog item for which this chart is being requested.</p></td>
        </tr>
...
<span class="param-type"><a href="Feature.html">Feature</a></span>
            ...
            <td class="description last"><p>The feature for which this chart is being requested.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>updateCounters</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Used for self-updating components. An object whose keys are timeoutIds, and whose values are
                  {reactComponent: ReactComponent, counter: Integer}. reactComponent is selected by this.isCorresponding.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>A description of the node in html, eg. {type: &quot;tag&quot;, name: &quot;chart&quot;, attribs: {src: &quot;filename.csv&quot;}, children: [], next: null, parent: null, prev: null}</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Object></span>
            ...
            <td class="description last"><p>The node's children.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line65">line 65</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="~selfUpdateSeconds"><span class="type-signature"></span>selfUpdateSeconds<span class="signature">(reactComponent)</span><span class="type-signature"> &rarr; {Integer}</span></h4>
...
<div class="description">
    <p>A function which checks a ReactComponent and returns an integer if it both
contains this custom component type, and that component would self-update (eg. from a &quot;poll-seconds&quot; attribute).</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ReactViews_Custom_CustomComponentType.js.html">ReactViews/Custom/CustomComponentType.js</a>, <a href="ReactViews_Custom_CustomComponentType.js.html#line87">line 87</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The number of seconds between updates of this component, or undefined.</p>
</div>
